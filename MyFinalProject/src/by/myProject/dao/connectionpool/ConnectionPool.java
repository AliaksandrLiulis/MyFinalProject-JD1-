package by.myProject.dao.connectionpool;
...
public class ConnectionPool {
	...
	public void initPoolData() throws SQLException, ClassNotFoundException {
		...
		for (int i = 0; i < poolSize; i++) {
			...
			connectionQueue.add(poolConnection);
		}
	}
	...
	private void closeConnectionsQueue(List<Connection> queue) throws SQLException {
	...
	public class PoolConnection implements Connection {
		...
		public PoolConnection(Connection c) throws SQLException {
			this.connection = c;
